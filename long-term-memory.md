...
## [2026-04-13] CVE-2026-21992 - Oracle Identity Manager + Web Services Manager: RCE sin autenticación (CVSS 9.8), alerta out-of-band

- **Source**: [Oracle Security Alert Advisory](https://www.oracle.com/security-alerts/alert-cve-2026-21992.html) / [The Hacker News](https://thehackernews.com/2026/03/oracle-patches-critical-cve-2026-21992.html) / [Help Net Security](https://www.helpnetsecurity.com/2026/03/23/oracle-emergency-fix-cve-2026-21992/) / [Tenable](https://www.tenable.com/blog/cve-2026-21992-critical-out-of-band-oracle-identity-manager-and-oracle-web-services-manager) / [BleepingComputer](https://www.bleepingcomputer.com/news/security/oracle-pushes-emergency-fix-for-critical-identity-manager-rce-flaw/)
- **Confidence**: Alta
- **What changes**: Oracle publicó el 19-20 de marzo de 2026 una **alerta de seguridad out-of-band** (fuera del ciclo trimestral CPU) para CVE-2026-21992 (CVSS 9.8, CWE-306 — Missing Authentication for Critical Function). El componente REST WebServices de Oracle Identity Manager y el componente Web Services Security de Oracle Web Services Manager exponen endpoints críticos sin requerir autenticación, permitiendo RCE remoto no autenticado. Vector: red, sin interacción de usuario, sin autenticación, baja complejidad. Afecta: Oracle Identity Manager **12.2.1.4.0** y **14.1.2.1.0**; Oracle Web Services Manager **12.2.1.4.0** y **14.1.2.1.0** (parte de Oracle Fusion Middleware). Sin explotación activa confirmada al momento del disclosure.
- **Action required**: Actualizar dependencia
- **Details**: Aplicar los parches disponibles en el Patch Availability Document (KB878741) a través de Oracle Support. Oracle recomienda actualizar antes de la siguiente CPU trimestral. Oracle Identity Manager es una pieza central de IAM (Identity and Access Management) empresarial — un compromiso permite a atacantes crear cuentas privilegiadas, resetear contraseñas, y acceder a todos los sistemas integrados. Oracle Web Services Manager gestiona las políticas de seguridad de servicios web SOAP/REST. Instancias expuestas en internet sin WAF son el mayor riesgo. El alerta out-of-band indica que Oracle consideró el riesgo suficientemente alto para no esperar al CPU de abril.

---

## [2026-04-13] CPUID supply chain attack - CPU-Z y HWMonitor troyanizados via API comprometida, STX RAT distribuido (9-10 abril 2026)

- **Source**: [The Hacker News](https://thehackernews.com/2026/04/cpuid-breach-distributes-stx-rat-via.html) / [BleepingComputer](https://www.bleepingcomputer.com/news/security/supply-chain-attack-at-cpuid-pushes-malware-with-cpu-z-hwmonitor/) / [The Register](https://www.theregister.com/2026/04/10/cpuid_site_hijacked/) / [Help Net Security](https://www.helpnetsecurity.com/2026/04/13/cpuid-download-malware/) / [Securelist (Kaspersky)](https://securelist.com/tr/cpu-z/119365/)
- **Confidence**: Alta
